    ...
    public partial class frmMain : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void cmdGo_Click(object sender, EventArgs e)
        {
            using (DXTools.Spreadsheet sSheet = new DXTools.Spreadsheet())
            {
                ...
                *************************************************************************************************************************/
                ...
                //DataView dv = new DataView(BudgetTable);
                //dv.RowFilter = "Section = 'Existing Customers' OR Section = 'NEW BUSINESS WON IN " + Classes.Global.ConvertToDateTime(dteReportDate.EditValue).AddYears(-1).ToString("yyyy") + " IMPACTING " + Year + "'";
                ...
                *************************************************************************************************************************/
                ...
                sms.Set_Chart(sSheet, "A13:M13", ChartType.ColumnClustered, SheetNumber, "Q2", "W11", "NEW BUSINESS WON IN " + LastYear + " IMPACTING " + Year);
        ...
        private List<BudgetModel> ConvertBudgetSheetToDataTable(int SheetIndex, int MaxRows, Spreadsheet sSheet)
        {
            try
            {
                ...
                //masterTable.Columns.Add("Existing Customers", typeof(string));
                //masterTable.Columns.Add("Jan", typeof(double));
                //masterTable.Columns.Add("Feb", typeof(double));
                //masterTable.Columns.Add("Mar", typeof(double));
                //masterTable.Columns.Add("Apr", typeof(double));
                //masterTable.Columns.Add("May", typeof(double));
                //masterTable.Columns.Add("Jun", typeof(double));
                //masterTable.Columns.Add("Jul", typeof(double));
                //masterTable.Columns.Add("Aug", typeof(double));
                //masterTable.Columns.Add("Sep", typeof(double));
                //masterTable.Columns.Add("Oct", typeof(double));
                //masterTable.Columns.Add("Nov", typeof(double));
                //masterTable.Columns.Add("Dec", typeof(double));
                //masterTable.Columns.Add("YTD", typeof(double));
                //masterTable.Columns.Add("Full Year Budget", typeof(double));
                //masterTable.Columns.Add("Section", typeof(string));
                        ...
                        if (EndIndex > 1 && newSection == false)
                        {
                            ...
                            if (SectionTable.Rows.Count > 0)
                            {
                                foreach (DataRow Row in SectionTable.Rows)
                                {
                                    ...
                                    //newRow["Existing Customers"] = Row[SectionTable.Columns[0].ColumnName];
                                    //newRow["Jan"] = Row["Jan"];
                                    //newRow["Feb"] = Row["Feb"];
                                    //newRow["Mar"] = Row["Mar"];
                                    //newRow["Apr"] = Row["Apr"];
                                    ...
                                    //newRow["Nov"] = Row["Nov"];
                                    //newRow["Dec"] = Row["Dec"];
                                    //newRow["YTD"] = Row[13]; // YTD Not on All tables 
                                    //newRow["Full Year Budget"] = Row[14]; // Full Year Budget Not on All tables 
                                    //newRow["Section"] = SectionTable.Columns[0].ColumnName;
